...
class Result {
    ...
    factory Result.fromJson(Map<String, dynamic> json) => Result(
        ...
        country: List<Country>.from(json["country"].map((x) => countryValues.map[x]!)),
...
final sourceIdValues = EnumValues({
    "sindonews": SourceId.SINDONEWS,
    "tribunnews": SourceId.TRIBUNNEWS
});
...
final sourceNameValues = EnumValues({
    "Sindonews": SourceName.SINDONEWS,
    "Tribun News": SourceName.TRIBUN_NEWS
});
